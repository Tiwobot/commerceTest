...
export default function TrustpilotBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 text-white text-center py-1.5 px-2 font-medium text-sm flex items-center justify-center gap-2 shadow-lg border-b border-neutral-800 z-[300]">
